#!/usr/bin/env python3
"""RELEASE CLOSURE — provision a deterministic production smoke exam.
Inserts via Supabase REST as the E2E teacher (RLS-permitted), class_id=NULL
(validateExamAccess checks enrollment only when class_id is set).
...
exam = {
    "id": exam_id,
    "title": "Production Release Smoke Exam (RC)",
    "description": "Deterministic 3-question exam verifying the production release: "
...
with open("/home/z/my-project/scripts/tmp/smoke-exam.json", "w") as f:
