...
export const faqData = [
  ...
  },
  {
    ...
    answer:
      "Security is built into the layers we control: TLS encryption in transit, five-role access control enforced server-side, comprehensive audit logging, row-level security on every database table, CSRF protection, and strict HTTP security headers — all verified by automated security scans. We run on Supabase's managed infrastructure. We do not offer an uptime SLA (we are honest about being early-stage); you can check live system health yourself on our status page.",
  },
  {
