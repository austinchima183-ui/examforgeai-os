...
const releases: Release[] = [
  ...
  },
  {
    ...
    description: 'The biggest release in ExamForge AI history. A complete redesign, the AI Assistant, and the parent portal.',
    changes: [
      ...
      { category: 'improvement', text: 'Security hardening: CSRF protection, security headers, and audit logging expansion' },
  ...
  },
  {
    ...
    description: 'In-app messaging hub connecting teachers, parents, and administrators, with email notification rails (provider-integrated).',
    changes: [
      { category: 'feature', text: 'Teacher–parent direct messaging with notification routing' },
      { category: 'feature', text: 'Email template builder with drag-and-drop editor' },
      { category: 'feature', text: 'Notification templates for exam reminders and announcements' },
