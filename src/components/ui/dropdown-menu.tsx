...
/* ══════════════════════════════════════════════════════════════════════════ */
/* ExamForge AI OS — Dropdown Menu Component                                 */
/* Glass elevated, rounded-lg, precise hover/focus bg, white/[0.04] items    */
/* ══════════════════════════════════════════════════════════════════════════ */
    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          "rounded-lg border border-white/[0.06] p-1",
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        /* Premium hover — precise white opacity */
        "transition-colors duration-150",
        "hover:bg-white/[0.04] focus:bg-white/[0.06] focus:text-foreground",
...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn("bg-white/[0.04] -mx-1 my-1 h-px", className)}
      {...props}
    />
  )
}
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        "forge-glass-elevated shadow-xl",
        "rounded-lg border border-white/[0.06] p-1",
        "text-popover-foreground",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
