...
/* ══════════════════════════════════════════════════════════════════════════ */
/* ExamForge AI OS — Drawer Component                                        */
/* Premium glass overlay, elevated glass content, AI OS design language       */
/* ══════════════════════════════════════════════════════════════════════════ */
    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          "forge-glass-elevated forge-card-shadow",
          /* Directional positioning and rounding */
      ...
      >
        {/* Premium grab handle */}
        <div className="mx-auto mt-4 hidden h-1.5 w-[60px] shrink-0 rounded-full bg-foreground/20 group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
