...
// ============================================================================
// ExamForge AI — (public) Route-Level Error Boundary
// ============================================================================
// Catches errors within public/auth pages (login, register, etc.).
// Shows error with retry and sign-in redirect options.
// ============================================================================

import { useEffect } from 'react'
import { AlertTriangle, RotateCw, LogIn, Bug } from 'lucide-react'
...
export default function PublicError({
  ...
  useEffect(() => {
    ...
    console.error('[ExamForge AI] Public/auth route error:', {
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center pb-2">
          ...
          <CardDescription className="mt-1">
            Something went wrong. Please try again or sign in to continue.
          </CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col items-center gap-4 text-center">
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            ...
            <Button variant="outline" asChild aria-label="Go to sign in page">
              <Link href="/login">
          ...
          <button
            ...
            onClick={() => {
              const subject = encodeURIComponent(`Auth Error Report: ${error.digest ?? 'Unknown'}`)
