...
import { FileText, Users, Clock, CheckCircle2, Plus, BarChart3, Zap, Layers } from 'lucide-react'
  ...
  return (
    <div className="space-y-6 animate-fade-in forge-ambient-bg min-h-screen">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
        <Card className="relative overflow-hidden forge-glass-surface border-white/[0.04] rounded-xl forge-card-shadow hover:-translate-y-0.5 hover:shadow-[0_2px_8px_rgba(59,130,246,0.15)] hover:border-white/[0.06] hover:-translate-y-0.5 transition-all duration-200 group">
          ...
          <CardHeader className="relative flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-muted-foreground/10 backdrop-blur-sm border border-white/[0.04] group-hover:border-white/[0.06] group-hover:bg-muted-foreground/15 transition-all duration-200">
              <Layers className="h-4 w-4 text-muted-foreground" />
            </div>
          </CardHeader>
          <CardContent className="relative">
            <div className="text-2xl font-bold tracking-tight">{data.exams.length}</div>
        ...
        <Card className="relative overflow-hidden forge-glass-surface border-white/[0.04] rounded-xl forge-card-shadow hover:-translate-y-0.5 hover:shadow-[0_2px_8px_rgba(59,130,246,0.15)] hover:border-white/[0.06] hover:-translate-y-0.5 transition-all duration-200 group">
          ...
          <CardContent className="relative">
            <div className="text-2xl font-bold tracking-tight">{data.stats.activeExams}</div>
        ...
        <Card className="relative overflow-hidden forge-glass-surface border-white/[0.04] rounded-xl forge-card-shadow hover:-translate-y-0.5 hover:shadow-[0_2px_8px_rgba(59,130,246,0.15)] hover:border-white/[0.06] hover:-translate-y-0.5 transition-all duration-200 group">
          ...
          <CardContent className="relative">
            <div className="text-2xl font-bold tracking-tight">{data.stats.upcomingExams}</div>
        ...
        <Card className="relative overflow-hidden forge-glass-surface border-white/[0.04] rounded-xl forge-card-shadow hover:-translate-y-0.5 hover:shadow-[0_2px_8px_rgba(59,130,246,0.15)] hover:border-white/[0.06] hover:-translate-y-0.5 transition-all duration-200 group">
          ...
          <CardContent className="relative">
            <div className="text-2xl font-bold tracking-tight">{data.stats.completedExams}</div>
        ...
        <Card className="relative overflow-hidden forge-glass-surface border-white/[0.04] rounded-xl forge-card-shadow hover:-translate-y-0.5 hover:shadow-[0_2px_8px_rgba(59,130,246,0.15)] hover:border-white/[0.06] hover:-translate-y-0.5 transition-all duration-200 group">
          ...
          <CardContent className="relative">
            <div className="text-2xl font-bold tracking-tight">{data.stats.totalParticipants}</div>
      ...
      <div className="flex items-center gap-3 mb-5">
        ...
        <Badge variant="outline" className="text-xs border-white/[0.04] bg-secondary/50 tabular-nums">{data.exams.length} total</Badge>
      </div>
      ...
      <Card className="forge-glass-surface border-white/[0.04] rounded-xl forge-card-shadow hover:-translate-y-0.5 hover:shadow-[0_2px_8px_rgba(59,130,246,0.15)] hover:border-white/[0.06] transition-all duration-200">
        <CardContent className="p-6">
          <Tabs defaultValue="all">
            <TabsList className="mb-4 bg-secondary/50 border border-white/[0.04] rounded-lg">
